                    ...
                    <div className={`footerContent`}>
                        <div className={`footer_contact`} style={{ width: '20rem' }}>
                            ...
                            <p className={inter?.className}>
                                Email ID: <span>editor.ijmahp@gmail.com</span>
                            </p>
                            <p className={`${inter?.className} m-0`}>
                                Helpline No.:
                            </p>
                            <p className={inter?.className}>
                                <span>+91 79843 77793</span>, <br /><span>+91 96873 06037</span>
                            </p>
                        </div>
                        ...
                        <div className={`linkContent`}>
                            <div className={`footerLinksContent mt-lg-4`}>
                                <div className={`footer_links`}>
                                    ...
                                    <ul>
                                        <li><i className="ri-arrow-right-s-line"></i> <Link href="/" title='Home | IJMAHP' className={inter?.className}>Home</Link></li>
                                        <li><i className="ri-arrow-right-s-line"></i> <Link href="/about/ijmahp" title='About Us | IJMAHP' className={inter?.className}>About us</Link></li>
                                        <li><i className="ri-arrow-right-s-line"></i> <Link href="https://app.oxfordabstracts.com/auth?redirect=/stages/81125/submitter" title='Submit Paper | IJMAHP' className={inter?.className}>Submit Paper</Link></li>
                                        <li><i className="ri-arrow-right-s-line"></i> <Link href="/author-tools/guidelines" title='Author Guidelines | IJMAHP' className={inter?.className}>Guidelines</Link></li>
                                    </ul>
                                </div>
                                ...
                                <div className={`footer_links`}>
                                    ...
                                    <ul>
                                        <li>
                                            <i className="ri-arrow-right-s-line"></i> <Link href='#' title='Sample Paper Format | IJMAHP' className={inter.className} onClick={(e) => saveAs(samplePaperFormat, 'Sample Paper - IJMAHP')}>Sample Paper Format</Link>
                                        </li>
                                        <li>
                                            <i className="ri-arrow-right-s-line"></i> <Link href='#' title='Undertaking Form | IJMAHP' className={`${router?.route?.includes('/ijmahp') && 'active'} ${inter.className}`} onClick={(e) => saveAs(underTakeForm, 'Undertaking Form - IJMAHP')}>Undertaking Form</Link>
                                        </li>
                                        <li>
                                            <i className="ri-arrow-right-s-line"></i> <Link href='#' title='Copyright Form | IJMAHP' className={`${router?.route?.includes('/ijmahp') && 'active'} ${inter.className}`} onClick={(e) => saveAs(copyrightForm, 'Copyright Form - IJMAHP')}>Copy Right Form</Link>
                                        </li>
                                        <li>
                                            <i className="ri-arrow-right-s-line"></i>  <Link href='/about/join-as-reviewer' title='Join As Reviewer | IJMAHP' className={inter.className}>Join As Reviewer</Link>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div className={`row footerCopyRight`} style={{ display: 'flex !important', alignItems: 'center', justifyContent: 'center', alignContent: 'center', padding: '20px', margin: '0 auto' }}>
                    ...
                    <div className="col-lg-8 p-0">
                        <div className={`copyright ${inter?.className}`}>
                            Copyright &copy; <span style={{ fontSize: '13px' }}>{copyRightYear || '2024'}</span>, <strong style={{ color: 'var(--primary-color)' }}>IJMAHP</strong>. All Rights Reserved, Subject to Judiciary of Ahmedabad.
                        </div>
